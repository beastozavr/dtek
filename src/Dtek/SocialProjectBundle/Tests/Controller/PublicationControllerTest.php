...
namespace Dtek\SocialProjectBundle\Tests\Controller;
...
class PublicationControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'dtek_socialprojectbundle_publicationtype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'dtek_socialprojectbundle_publicationtype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
